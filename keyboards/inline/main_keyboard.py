...
def main_markup() -> InlineKeyboardMarkup:
    ...
    button_low = InlineKeyboardButton(text='Выполнить перевод одного слова по "Яндекс.Словарю"', callback_data='low')
    button_high = InlineKeyboardButton(text='Выполнить перевод текста по "Яндекс.Переводчику"', callback_data='high')
